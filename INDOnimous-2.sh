...
# Auto Install Tools v.2.2
# system by INDOnimous Dev
# Bisa Karena belajar... 
# Bersihkan Layar
clear
...
sleep 1
echo ""
echo -e $green"[#]> Terima kasih sudah menggunakan tools sederhana ini.. "
sleep 1
echo ""
echo -e $white"[#]> INDOnimous Device "
read enter
exit
} 
echo  "           ***********************************************"
echo  "           # Tutorial Dear User                          #"
echo  "           # Jangan lupa suport                          #"
echo  "           # contact: PenggunaTermux@gmail.com           #"
echo  "           # Thanks for INDOnimous support               #"
echo  "           # DibawahNaungan INDOnimous                   #"
echo  "           # Thanks for supporting me                    #"
echo  "           ***********************************************"
echo "" 
echo "" 
echo   " #INDOnimous 01--> Metasploit "
echo   " #INDOnimous 02--> Kali Nethunter"
echo   " #INDOnimous 03--> Hunner"
echo   " #INDOnimous 04--> WPScan"
echo   " #INDOnimous 05--> Webdav"
echo   " #INDOnimous 06--> Red Hawk"
echo   " #INDOnimous 07--> D-Tect "
echo   " #INDOnimous 08--> Ubuntu"
echo   " #INDOnimous 09--> Youtube Dl"
echo   " #INDOnimous 10--> viSQL "
echo   " #INDOnimous 11--> Weeman"
echo   " #INDOnimous 12--> WFDroid"
echo   " #INDOnimous 13--> FBBrute"
echo   " #INDOnimous 14--> Ngrok"
echo   " #INDOnimous 15--> Torshammer "
echo   " #INDOnimous 16--> RouterSploit "
echo   " #INDOnimous 17--> Hydra "
echo   " #INDOnimous 18--> Weevely "
echo   " #INDOnimous 19--> SQLMap "
echo   " #INDOnimous 20--> Dirbuster "
echo   " #INDOnimous 21--> admin finder "
echo   " #INDOnimous 22--> lokomedia exploiter "
echo   " #INDOnimous 23--> elfinder exploiter "
echo   " #INDOnimous 24--> magento add admin exploiter "
echo   " #INDOnimous 25--> scanner tools "
echo   " #INDOnimous 26--> bing dorker "
echo   " #INDOnimous 27--> katoolin "
echo   " #INDOnimous 28--> arch linux "
echo   " #INDOnimous 29--> linux fedora"
echo   " #INDOnimous 30--> hash-buster"
echo   " #INDOnimous 31--> sudo"
echo   " #INDOnimous 32--> aircrack-ng"
echo   " #INDOnimous 33--> joomscan"
echo   " #INDOnimous 34--> bing-ip2hosts"
echo   " #INDOnimous 35--> BlueMaho"
echo   " #INDOnimous 36--> Bluepot"
echo   " #INDOnimous 37--> honeypot"
echo   " #INDOnimous 38--> bot auto deface 1"
echo   " #INDOnimous 39--> bot auto deface 2"
echo   " #INDOnimous 40--> mailer sender cli"
echo   " #INDOnimous 41--> Wordpress Brute Force"
echo   " #INDOnimous 42--> Oh-myzsh theme for termux"
echo   " #INDOnimous 43--> instabot (instagram bot)"
echo   " #INDOnimous 44--> fsociety"
echo   " #INDOnimous 45--> Cms Scanner"
echo   " #INDOnimous 46--> Information Gathering"
echo   " #INDOnimous 47--> com_fabrik exploiter"
echo   " #INDOnimous 48--> com foxcontact exploiter"
echo   " #INDOnimous 49--> gmail brute force"
echo   " #INDOnimous 50--> ezsploit"
echo   " #INDOnimous 51--> spammer-grab sms"
echo   " #INDOnimous 52--> spammer call toko-pedia"
echo   " #INDOnimous 53--> The Fat Rat"
echo   " #INDOnimous 54--> IPGeolocation"
echo   " #INDOnimous 55--> LITE DDos ATTACK "
echo,  " #INDOnimous  56--> LITE SPAM SMS "
echo   " #INDOnimous 99--> exit"
echo   ""

read -p "[root@INDOnimous]# " act;

if [ $act = 56 ]  || [ $act = 56 ] 
then 
clear 
echo -e $red "Menginstall LITE SPAM" 
sleep 1
apt-get update 
apt-get upgrade 
apt-get install php
...
pkg install toilet 
pkg install git
git clone https://www.github.com/4L13199/LITESPAM
cd LITESPAM
sh LITEAPAM.sh
echo "TERINSTALL"
fi
...
then
clear
echo -e $red " Menginstall LITEDDOS " 
sleep 1
apt-get update
apt-get upgrade 
...
cd LITEDDOS 
echo "Untuk menjalankannya ketik" python2 LITEDDOS IP WEB Port Ping "tanpa tanda petik" 
echo $red "TERINSTALL"  
fi
...
sleep 1
echo -e $green" Jangan Pernah berhenti dan menyerah "
sleep 1
echo -e $green" Ilmu yang berguna adalah ilmu yang bermanfaat "
sleep 1
echo -e $green" Please Wait.... "
sleep 1
echo -e $green" contact : PenggunaTermux@gmail.com "
sleep 1
echo -e $red" Blogs : www.blogger.com/indonimous.blogspot.com "
sleep 1
